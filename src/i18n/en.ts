...
export const dict = {
  ...
  "err.INVALID_SKILL_NAME": "Invalid skill name: {{name}} (contains forbidden characters or is a reserved name)",
  ...
  "plan.createLink": "- create link [{{agent}}] {{target}} -> {{link}}",
  "plan.copyToSsot": "- copy to SSOT {{source}} -> {{target}}",
  "plan.updateState": "- update state {{skillName}}",
  "plan.removeLink": "- remove link [{{agent}}] {{target}}",
